...
namespace intern_track_back.Migrations
{
    ...
    [Migration("20220626100533_AddStudentPlanIntVacancyLink")]
    partial class AddStudentPlanIntVacancyLink
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("intern_track_back.Models.Interview", b =>
                {
                    ...
                    b.Property<int>("StudentInterviewStatusType")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("intern_track_back.Models.StudentPlanIntVacancyLink", b =>
                {
                    ...
                    b.HasKey("StudentPlanForInterviewId", "VacancyId");

                    b.HasIndex("VacancyId");

                    b.ToTable("StudentPlanIntVacancyLinks");
                });
            ...
            modelBuilder.Entity("intern_track_back.Models.Student", b =>
                {
                    ...
                    b.Property<int>("GeneralStudentStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("intern_track_back.Models.StudentPlanIntVacancyLink", b =>
                {
                    b.HasOne("intern_track_back.Models.StudentPlanForInterview", "StudentPlanForInterview")
                        .WithMany("StudentPlanIntVacancyLinks")
            ...
            modelBuilder.Entity("intern_track_back.Models.StudentPlanForInterview", b =>
                {
                    b.Navigation("StudentPlanIntVacancyLinks");
                });
